...
<html lang="es">
    ...
    <body>
        ...
        <div class="container buscar">
            <h1>Compras buscar por fecha AÑO/MES/FECHA</h1>
            <br>
            ...
            <%
                ...
                smt=con.conectar().createStatement();
                rs=smt.executeQuery("SELECT m.*,p.nombre as producto, c.nombres as proveedor FROM compras m LEFT JOIN productos p ON m.producto_id = p.id LEFT JOIN proveedores c ON m.proveedor_id = c.id where fecha LIKE"+"'%"+nombuscar+"%'");
                }else{
