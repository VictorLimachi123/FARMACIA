...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="text-primary"><em><u>CLIENTE</u></em></h1>
           
       
            <br>
            <p>

            <a href="ClienteControlador?action=add" class="btn btn-success btn-sm"><i class="fa-sharp fa-solid fa-circle-plus"></i> Nuevo </a>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th class="p-3 mb-2 bg-warning text-dark">Celular</th>
                ...
                <c:forEach var="item" items="${clientes}">
                    ...
                    <td class="p-3 mb-2 bg-white text-dark">${item.celular}</td>
                     ...
                     <td class="p-3 mb-2 bg-white text-dark"><a href="ClienteControlador?action=edit&id=${item.id}" >
                            <i class="fa fa-edit"></i></a></td>
                    <td class="p-3 mb-2 bg-white text-dark"><a href="ClienteControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro de eliminar'))" >
