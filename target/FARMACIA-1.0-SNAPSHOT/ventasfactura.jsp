...
<html lang="es">
    ...
    <body>
        ...
        <div class="container buscar">
            <h1>Ventas buscar por factura</h1>
            <br>
            ...
            <%
                ...
                smt=con.conectar().createStatement();
                rs=smt.executeQuery("SELECT v.*,p.nombre as producto, c.nombres as cliente FROM ventas v LEFT JOIN productos p ON v.producto_id = p.id LEFT JOIN clientes c ON v.cliente_id = c.id where factura LIKE"+"'%"+nombuscar+"%'");
                }else{
