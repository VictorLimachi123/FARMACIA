...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <h1 class="text-primary"><em><u>VENTA</u></em></h1>      
       
            <br>
            <p>

            <a href="VentaControlador?action=add" class="btn btn-success btn-sm"><i class="fa-sharp fa-solid fa-circle-plus"></i> Nuevo </a>
            </p>
            ...
            <table class="table table-striped">
                <tr>
                    ...
                    <th class="p-3 mb-2 bg-warning text-dark">Cliente</th>
                ...
                <c:forEach var="item" items="${ventas}">
                 ...
                 <tr>
                    ...
                    <td class="p-3 mb-2 bg-white text-dark">${item.cliente}</td>
                    
                     <td class="p-3 mb-2 bg-white text-dark"><a href="VentaControlador?action=edit&id=${item.id}" >
                            <i class="fa fa-edit"></i></a></td>
                    <td class="p-3 mb-2 bg-white text-dark"><a href="VentaControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro de eliminar'))" >
